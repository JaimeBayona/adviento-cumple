    ...
    "
      ...
      "
        ...
        <p className="mt-5 sm:mt-8 max-w-sm sm:max-w-md text-[13px] sm:text-sm text-black/65 leading-relaxed">
          Veinte días distintos, como una caja de sorpresas: unos fáciles de
          abrir, otros llenos de energía, pero todos con algo que disfrutar.
        </p>
      </div>

      {/* Flecha */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-black/40">
        <span className="text-[9px] uppercase tracking-[0.35em]">Scrollea</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
